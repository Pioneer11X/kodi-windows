...
namespace kodi {
    ...
    EventGLFW::EventGLFW(){
        ...
        this->mouseButtonTranslations.insert( std::pair<int, int>( GLFW_MOUSE_BUTTON_LEFT, MOUSE_BUTTONS::MOUSEKEY_LEFT ) );
        this->mouseButtonTranslations.insert( std::pair<int, int>( GLFW_MOUSE_BUTTON_RIGHT, MOUSE_BUTTONS::MOUSEKEY_RIGHT ) );
        this->mouseButtonTranslations.insert( std::pair<int, int>( GLFW_MOUSE_BUTTON_MIDDLE, MOUSE_BUTTONS::MOUSEKEY_MIDDLE ) );
