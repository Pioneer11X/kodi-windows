...
namespace kodi {
    ...
    EventSFML::EventSFML(){
        ...
        this->mouseButtonTranslations.insert( std::pair<int, int>( sf::Mouse::Left, MOUSE_BUTTONS::MOUSEKEY_LEFT ) );
        this->mouseButtonTranslations.insert( std::pair<int, int>( sf::Mouse::Right, MOUSE_BUTTONS::MOUSEKEY_RIGHT ) );
        this->mouseButtonTranslations.insert( std::pair<int, int>( sf::Mouse::Middle, MOUSE_BUTTONS::MOUSEKEY_MIDDLE ) );
