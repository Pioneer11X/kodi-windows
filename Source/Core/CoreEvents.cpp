...
namespace kodi
{
    ...
    bool CoreEvents::Init(int eventFramework){
        
        this->keyboardStatus = KEYSTATUS::KB_NOT_PRESSED;
        
        switch(eventFramework){
            case KE__SDL:
                eventObject = new EventSDL();
                break;
            case KE__GLFW:
                eventObject = new EventGLFW();
                break;
            case KE__SFML:
                eventObject = new EventSFML();
                break;
            default:
                eventObject = new EventGLFW();
                break;
        }
        this->eventObject->Construct( );
    ...
    {
        return this->eventObject->GetKeyNumber( key );
    }
